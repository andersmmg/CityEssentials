...
public class StopSignBlockEntity extends BlockEntity implements EditableSign {
    private Text text = Text.literal("");

    public StopSignBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntities.STOP_SIGN_BLOCK_ENTITY, blockPos, blockState);
    }
