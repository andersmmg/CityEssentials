...
public class SpeedLimitSignBlockEntity extends BlockEntity implements EditableSign {
    private Text text = Text.literal("");

    public SpeedLimitSignBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntities.SPEED_LIMIT_SIGN_BLOCK_ENTITY, blockPos, blockState);
    }
