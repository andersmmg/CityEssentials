...
public class StreetSignEditScreen extends BaseOwoScreen<FlowLayout> {
    ...
    public StreetSignEditScreen(StreetSignBlockEntity entity) {
    ...
    protected void build(FlowLayout rootComponent) {
        ...
        var textBox = Components.textBox(Sizing.fixed(85), signEntity.getText().getString());
        ...
        rootComponent.child(
                Containers.verticalFlow(Sizing.content(), Sizing.content())
                        .child(Components.label(Text.translatable("gui.cityessentials.street_sign.edit_text")))
                        .child(textBox)
                        .gap(5)
