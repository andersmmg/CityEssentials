...
public class ModScreenHandlers {
    ...
    public static final ScreenHandlerType<WalletScreenHandler> WALLET_SCREEN_HANDLER = new ScreenHandlerType<>(WalletScreenHandler::new, FeatureFlags.VANILLA_FEATURES);
    ...
    public static void registerScreenHandlers() {
        ...
        Registry.register(Registries.SCREEN_HANDLER, CityEssentials.id("wallet"), WALLET_SCREEN_HANDLER);
    }
    ...
    public static void registerScreens() {
        ...
        HandledScreens.register(WALLET_SCREEN_HANDLER, WalletScreen::new);
    }
